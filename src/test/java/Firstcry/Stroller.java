...
public class Stroller {
    ...
    @Test (priority=5)
    void stroller() {
		WebElement s=driver.findElement(By.xpath("//div[@class='header']//div[6]"));
        s.click();
        
}
    
    @Test  (priority=6)
    void babyhug_stroller() {
		WebElement bs=driver.findElement(By.xpath("//li[normalize-space()='Babyhug Stroller']"));
        bs.click();
}
    
    @Test (priority=7)
    void babyhug_cosycosmo() {
		WebElement bcc=driver.findElement(By.xpath("//html[1]/body[1]/div[1]/div[1]/div[2]/div[2]/div[4]/div[1]/div[1]/a[1]/button[1]"));
        bcc.click();
}
